...
#define QT_BUILD_KEY "arm linux pandora-g++ full-config"
...
#if defined(QT_GRAPHICSSYSTEM_OPENGL) && defined(QT_NO_GRAPHICSSYSTEM_OPENGL)
# undef QT_GRAPHICSSYSTEM_OPENGL
#elif !defined(QT_GRAPHICSSYSTEM_OPENGL) && !defined(QT_NO_GRAPHICSSYSTEM_OPENGL)
# define QT_GRAPHICSSYSTEM_OPENGL
#endif
